...
* Auth
    ...
    * Chức năng đăng ký: Đăng nhập bằng tài khoản Google, Tài khoản (Email, Số điện thoại và mật khẩu)
        * Chi tiết
        ...
        * Đăng ký bằng Tài khoản (Email, Số điện thoại và mật khẩu)
            * Hiển thị form đăng ký:
                ...
                * Các trường thông tin bao gồm:
                    ...
                    * Xác nhận mật khẩu.
            * Người dùng nhập thông tin tài khoản
                * Nhập email hoặc số điện thoại và mật khẩu vào form đăng ký.
            ...
            * Các yêu cầu bổ sung:
                * Xác minh email/số điện thoại: Gửi email hoặc tin nhắn xác minh để đảm bảo tính chính xác của thông tin người dùng trong vòng 120s.
                * Mã hóa mật khẩu: Mật khẩu người dùng cần được mã hóa trước khi lưu trữ trong cơ sở dữ liệu.
...
* Chức năng quản lý thông tin cá nhân
    * Chức năng thay đổi thông tin cá nhân: Thay đổi tên và các thông tin cá nhân khác.
        * Truy cập trang cài đặt cá nhân:
            * Người dùng đăng nhập vào tài khoản của họ và điều đến trang cài đặt tài khoản.
        * Cập nhật thông tin:
            * Người dùng sẽ thấy các trường thông tin cá nhân của họ (tên, email, khối lớp, trường học, …) và người dùng có thể nhập thông tin mới vào các trường đã cho.
        * Xác nhận thay đổi:
...
* Tìm kiếm khóa học và bài viết và lộ trình
    * Người dùng nhập vào thanh tìm kiếm để tìm khóa học | bài viết và hiển thị lại nội dung liên quan với nội dung nhập vào.
        * Chi tiết:
            * Trên header có thanh tìm kiếm, người dùng nhập vào các ký tự hoặc từ khóa liên quan tới bài viết hay khóa học (môn học, khối lớp, tên giáo viên). Sau khi nhập xong có thể Enter hoặc Click vào nút button có icon kính lúp ở bên cạnh thanh tìm kiếm.
            * Sau khi nhấn tìm kiếm sẽ hiển thị những khóa học và bài viết và lộ trình liên quan.
    ...
    * Khóa học có phí:
        * Chi tiết:
            * Học viên chọn khóa học muốn học. Bấm nút thanh toán sẻ đến tới trang thanh toán. Có 3 phương thức thanh toán là VietQR Napas 24/7, MoMo và VnPay.
...
* Mua và thanh toán khóa học
    * Danh sách khóa học
        ...
        * Cho phép tìm kiếm khóa học theo tên,theo lộ trình, khối lớp, môn học, giá, hoặc giảng viên.
...
* Chức năng quản lý học trực tuyến trên Schoolify (Learning Management System)
    ...
    * Bao gồm:
        * Học tập
            ...
            * Không tua khi học
                * Học viên không thể bỏ qua các bài học, bắt buộc học lần lượt.
            * Làm bài tập
                * Nếu bài học có bài tập, học viên cần làm bài tập trước khi qua bài tiếp theo.
        ...
        * Xem bài viết và bình luận
            * Bài viết
                * Học viên có thể truy cập mục bài viết trên website để đọc các bài viết liên quan đến các chủ đề giáo dục K-12, kinh nghiệm học tập, hướng dẫn kỹ năng, v.v.
...
* Chức năng của giảng viên
    * Tạo khóa học
        * Giảng viên có thể tạo khóa học mới, nhập thông tin khóa học bao gồm tên khóa học, mô tả, khối lớp, môn học, bộ sách và số lượng bài học dự kiến.
    * Quản lý bài học:
...
* Feedback
    ...
    * Người dùng được quyền phản hồi khóa học khi đã hoàn thành.
        * Chi tiết:
            ...
            * Đánh giá hoặc phản hồi sẽ được hiển thị trên trang chia tiết của khóa học.
...
* Chat Instructor
    * Tương tự như phần chat member nhưng có thêm phần đóng group, chặn và duyệt thành viên ở góc bên trên màn hình.
...
* Chức Năng Bài Tập Khóa Học
    * Các Loại Bài Tập
        * Bài Tập Lý Thuyết (Quiz):
            * Câu hỏi trắc nghiệm: Học viên chọn đáp án đúng từ các lựa chọn có sẵn (A, B, C, D).
            * Câu hỏi điền từ: Học viên điền từ, cụm từ hoặc số vào chỗ trống trong câu.
            * Câu hỏi đúng/sai: Học viên xác định tính đúng hoặc sai của một mệnh đề.
            * Lời giải chi tiết: Sau khi nộp bài hiển thị đáp án và hướng dẫn giải chi tiết từng câu.

* Chức Năng Nhận Chứng Chỉ Khóa Học
    * Người dùng được nhận chứng chỉ sau khi học xong 100% khóa học.
    * Xác nhận thông tin (cho chỉnh sửa tên).
...
* Phân quyền Admin cho các bộ phận
    ...
    * Bộ phận Quản lý khóa học
        ...
        * Phần hồi các thông tin cần sửa đổi:
